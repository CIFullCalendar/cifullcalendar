# CIFullCalendar v2 - Legacy **2.7.7.0**.

## Overview

CIFullCalendar is a server-side calendar and scheduling web application built on CodeIgniter 2. It provides tools for publishing, managing, and sharing events across public and private views, with role-based access for visitors, members, and administrators.
...
- Data: MySQL or any database driver supported by CodeIgniter v2
...
- User documentation: <https://cifullcalendar.com/v2/docs>
- Support: <https://sirdre.com>

## License and Terms

- License: <https://cifullcalendar.com/v2/docs/license.html>
- Terms and conditions: <https://cifullcalendar.com/v2/docs/terms.html>
