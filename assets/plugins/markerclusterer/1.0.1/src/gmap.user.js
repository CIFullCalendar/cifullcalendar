...
var regex = new RegExp("index.php/calendar/gmaps|calendar/gmaps"); 
var map;
...
var base_url = window.location.protocol + "//" 
				...
				+ window.location.pathname.replace(regex, '') 
				+ "assets/img/pin/";
				
var base_url2 = window.location.protocol + "//" 
				+ window.location.host
				+ window.location.pathname.replace('calendar/gmaps', '')
				+ "calendar";
...
function gmaps_category(category) {
    ...
    var url = "gmaps/get_marker?category="+category;
