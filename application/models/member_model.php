...
class Member_model extends CI_Model 
{
    ...
    * @return none
    */
    function fullCalendarSettings($id, $language, $timezone, $defaultview, $header_left, $header_center, $header_right, $aspectratio, $hiddendays, $firstday, $businessdays, $businessstart, $businessend, $weeknumbers, $eventlimit, $alldayslot, $slotlabeling, $slotlabelformat, $slotduration, $isrtl, $mintime, $maxtime) {
