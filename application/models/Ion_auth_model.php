...
class Ion_auth_model extends CI_Model
{
    ...
    */
	...
	public function change_email($code, $old_email, $new_email)
	{
		...
		if ($old_email_matches === TRUE)
		{
			...
			return $successfully_changed_email;
		}
	 ...
	 **/
	public function forgotten_password($identity, $identifier)
	{
		if (empty($identity))
		{
		...
		$this->db->update($this->tables['users'], $update, array($identifier => $identity)); //sirdre
	...
	**/
	...
	public function update_last_login($id)
	{
		...
		$this->db->update($this->tables['users'], array('last_login' => time(), 'ip_address' => $this->_prepare_ip($this->input->ip_address())), array('id' => $id)); //sirdre
