	...
	*/
    ...
    public function get_lang($lang) {
 	...
 	public function langtotime($date_string, $lang) { 
		...
		if($lang == 'ar'){
			$str = strtotime(strtr(strtolower($date_string), array('السبت'=>'saturday','الجمعة'=>'friday','الخميس'=>'thursday','الأربعاء'=>'wednesday','الثلاثاء'=>'tuesday','الإثنين'=>'monday','الأحد'=>'sunday','كانون الثاني يناير'=>'jan','شباط فبراير'=>'feb','آذار مارس'=>'march','نيسان أبريل'=>'apr','أيار مايو'=>'may','حزيران يونيو'=>'jun','تموز يوليو'=>'jul','آب أغسطس'=>'aug','أيلول سبتمبر'=>'sep','تشرين الأول أكتوبر'=>'oct','تشرين الثاني نوفمبر'=>'nov','كانون الأول ديسمبر'=>'dec','ص'=>'am','م'=>'pm','١'=>'1','٢'=>'2','٣'=>'3','٤'=>'4','٥'=>'5','٦'=>'6','٧'=>'7','٨'=>'8','٩'=>'9','٠'=>'0'))); 
		} else if($lang == 'fr'){
