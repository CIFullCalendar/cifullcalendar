                        ...
                        <div class="col-md-12 product-background">
                            <div class="row">								
                                ...
                                <div class="col-sm-5 col-md-12 col-lg-5">
									...
									<strong><?php echo $site_name ?></strong> v<strong><?php echo $current_version ?></strong> with legacy <?php echo 'CodeIgniter v<strong>' . CI_VERSION . '</strong>' ?> and FullCalendar v<strong><span id="fcv"></span></strong>* fused like a&ldquo;Super Saiyan Fusion&rdquo;.
									</div></h2> 
