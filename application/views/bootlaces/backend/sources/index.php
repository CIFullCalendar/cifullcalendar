                                ...
                                <div class="panel-body">
									...
									<div class="table-responsive">
										<div id="toolbar"> 
											...
											<button class="btn btn-default" data-title="upload" data-toggle="modal" data-target="#upload" data-placement="top" ><i class="fa fa-cloud-upload"></i> <?php echo lang('calendar_import'); ?></button>  
										</div>							
		...
		<div class="modal fade" id="upload" tabindex="-2" role="dialog" aria-labelledby="upload" aria-hidden="true">
		  <div class="modal-dialog">
			<div class="modal-content">
				...
				<?php echo form_open_multipart('calendar/sources/upload_ical', array('id' => 'upload_file', 'name' => 'upload_file', 'role' => 'form')); ?> 
