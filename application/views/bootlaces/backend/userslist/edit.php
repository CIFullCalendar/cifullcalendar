													...
													<div class="row-fluid">
														...
														<div class="col-md-8"> 		 
															<div class="form-group">
																<input type="text" class="form-control" name="fname" id="fname" value="<?php echo $user->first_name  ?>" placeholder="<?php echo lang('admin_table_fname'); ?>">
															</div> 								
															<div class="form-group">
																<input type="text" class="form-control" name="lname" id="lname" value="<?php echo $user->last_name  ?>" placeholder="<?php echo lang('admin_table_lname'); ?>">
															</div> 	   
															<div class="form-group"> 
																<textarea class="form-control" type="text" name="address" id="address" placeholder="<?php echo lang('profile_edit_address') ?>" ><?php echo $user->address; ?> </textarea>  
															</div>	 
															<div class="form-group">
																<input type="text" class="form-control" name="company" id="company" value="<?php echo $user->company  ?>" placeholder="<?php echo lang('admin_table_company'); ?>">
															</div>											
															<div class="form-group">
																<input type="text" class="form-control" name="phone" id="phone" value="<?php echo $user->phone  ?>" placeholder="<?php echo lang('admin_table_phone'); ?>">
															</div> 								
															<div class="form-group">
																<input type="text" class="form-control" name="email" id="email" value="<?php echo $user->email  ?>" placeholder="<?php echo lang('admin_table_email'); ?>">
															</div> 												
