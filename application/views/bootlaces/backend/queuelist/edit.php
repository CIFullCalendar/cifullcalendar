                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-toolbar">   
                            <div class="btn-group pull-right">   
								<button class="btn btn-danger btn-sm" data-title="Delete" data-toggle="modal" data-target="#del_<?php echo $events->id  ?>" data-placement="top" ><i class="fa fa-times"></i> <?php echo lang('decline'); ?></button> 
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="panel-body">
									<div class="row">
										...
										<?php echo form_open('admin/queuelist/edit/'.$events->id, array('class' => 'form-horizontal', 'id' => 'form_edit'.$events->id, 'name' => 'form_edit', 'role' => 'form' )); ?>  
															...
															<div class="form-group">	
																...
																<div class="col-md-7 col-xs-7">	
																	<select class="form-control" name="ic_event_shareit" id="ic_event_shareit">		 
																	  <option id="ic_event_ahareit" value="0" <?php if ($events->gid == 0) { echo 'selected';} ?>><?php echo lang('calendar_modal_eventprivate'); ?></option>
																	  <option id="ic_event_ahareit" value="-3" <?php if ($events->gid < 0) { echo 'selected';} ?>><?php echo lang('calendar_modal_eventpublic'); ?></option>	  
																	<?php foreach ($groups as $group):?> 
																	  <?php $selected = null; if ($group['id'] == $events->gid) {$selected = 'selected';} ?>
																	  <option id="ic_event_ahareit" value="<?php echo $group['id'];?>" <?php echo $selected;?>><?php echo htmlspecialchars($group['name'],ENT_QUOTES,'UTF-8');?></option> 
																	<?php endforeach ?> 	  
																	</select> 
																</div>					
															</div>
												...
												<div class="btn-group">
													<input type="submit" name="submitEdit" id="submitEdit" class="btn btn-success" value="<?php echo lang('approve'); ?>" > </input> 
												</div>								
												<div class="btn-group">
