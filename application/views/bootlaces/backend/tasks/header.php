	...
	<!-- CIFullCalendar CSS -->	 
	<link rel="stylesheet" href="<?php echo base_url();?>assets/plugins/jquery/jquery.ui-1.11.4.css" type="text/css" /> 
	<link rel="stylesheet" href="<?php echo base_url();?>assets/bootlaces/css/tasks.css" type="text/css" />
