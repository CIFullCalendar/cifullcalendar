            ...
            <div class="page-header-inner "> 
                ...
                <div class="top-menu"> 
                    ...
                    <ul class="nav navbar-nav pull-right">  
						...
						<li class="shortcut"><?php echo anchor('/admin', lang('admin_dashboard') ) ?></li> 	
						<?php endif ?>  
								...
								<div class="navbar-content ">
									<div class="row">
										...
										<div class="col-md-7">
											...
											<a href="<?php echo site_url('calendar/gmaps');?>" class="btn" ><i class="fa fa-location-arrow"></i></a>
											<a href="<?php echo site_url('calendar/categories');?>" class="btn" ><i class="fa fa-list"></i></a>
											<a href="<?php echo site_url('calendar/sources');?>" class="btn" ><i class="fa fa-link"></i></a>
											<?php if ($this->ion_auth->is_admin()): ?>		
												<a href="<?php echo site_url('admin');?>" class="btn" ><i class="fa fa-dashboard"></i></a>
											<?php endif ?>
										</div>
									</div>
								</div>
            ...
            <div class="page-sidebar-wrapper"> 
                ...
                <div class="page-sidebar navbar-collapse collapse"> 
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-closed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px"> 
                        ...
                        <li class="nav-item ">  
							<a href="<?php echo site_url('calendar');?>" class="nav-link nav-toggle"  ><i class="fa fa-calendar fa-fw"></i> <span class="title"><?php echo lang('calendar') ?></span><span class="selected"></span></a> 
                        </li>					
						<li class="nav-item  ">
							<a href="<?php echo site_url('calendar/gmaps');?>" class="nav-link nav-toggle" ><i class="fa fa-location-arrow fa-fw"></i> <span class="title"><?php echo lang('submenu_dropdown_all_locations'); ?></span></a> 
						</li> 
						<li class="nav-item  ">
							<a href="<?php echo site_url('calendar/categories');?>" class="nav-link nav-toggle" ><i class="fa fa-list fa-fw"></i> <span class="title"><?php echo lang('submenu_dropdown_all_categories'); ?></span></a>
						</li> 						
						<li class="nav-item  "> 
							<a href="<?php echo site_url('calendar/sources');?>" class="nav-link nav-toggle" ><i class="fa fa-link fa-fw"></i> <span class="title"><?php echo lang('submenu_dropdown_all_sources'); ?></span></a>
						</li>  
