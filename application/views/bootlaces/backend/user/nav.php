            ...
            <div class="page-sidebar-wrapper"> 
                ...
                <div class="page-sidebar navbar-collapse collapse"> 
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-closed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px"> 
                        ...
                        <li class="nav-item ">  
							<a href="<?php echo site_url('profile');?>" class="nav-link nav-toggle"  ><i class="fa fa-calendar fa-fw"></i> <span class="title"><?php echo lang('calendar') ?></span><span class="selected"></span></a> 
                        </li>					
						<li class="nav-item  ">
						...
						<li class="nav-item  ">
							<a href="<?php echo site_url('profile/categories');?>" class="nav-link nav-toggle" ><i class="fa fa-list fa-fw"></i> <span class="title"><?php echo lang('submenu_dropdown_all_categories'); ?></span></a>
						</li> 						
						<li class="nav-item  "> 
