						...
						<li class="dropdown dropdown-user"><!-- /.shortcut -->
							...
							<ul class="dropdown-menu pull-right" role="menu">
								...
								<li class="nav-item"><!-- /.nav-item -->
									<a href="<?php echo site_url('calendar');?>"><i class="fa fa-calendar fa-fw"></i> <?php echo lang('calendar') ?></a> 
								</li>               
								<li class="nav-item "><!-- /.nav-item -->
									<a href="<?php echo site_url('calendar/gmaps');?>" ><i class="fa fa-location-arrow"></i> <?php echo lang('submenu_dropdown_all_locations'); ?></a>
								</li>				
								<li class="nav-item "><!-- /.nav-item -->
									<a href="<?php echo site_url('calendar/categories');?>" ><i class="fa fa-list"></i> <?php echo lang('submenu_dropdown_all_categories'); ?></a>
								</li>				
								<li class="nav-item "><!-- /.nav-item -->
									<a href="<?php echo site_url('calendar/sources');?>" ><i class="fa fa-link"></i> <?php echo lang('submenu_dropdown_all_sources'); ?></a>
								</li>
								<li class="divider"></li>								
								<li class="nav-item  ">
								...
								<li class="divider"></li>
								<li class="nav-item  ">
									<a href="<?php echo site_url('admin/logout');?>"><i class="fa fa-sign-out fa-fw"></i> <?php echo lang('profile_log_out')?></a>
								</li>	
							</ul>	
