                        ...
                        <div class="page-toolbar">  
                            <div class="btn-group col-md-4 col-sm-4 pull-right">  
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">  
                                    <li>  
                                        <a href="<?php echo site_url('calendar/home/export_all');?>">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-sm-12"> 
											...
											<div class="pull-left"><span id="timezone"></span></div>
											<div class="pull-right"><div class="hero hero-moment"><span id="digiclock"></span><span id="ampm"></span></div></div> 
						...
						<div class="modal-body">	
								 ...
								 <ul class="nav nav-tabs">
									...
									<li><a href="#pane2" data-toggle="tab"><i class="fa fa-paint-brush"></i> <?php echo lang('calendar_modal_tabtitle2'); ?></a></li> 
								 	<li><a href="#pane3" data-toggle="tab"><i class="fa fa-refresh"></i> <?php echo lang('calendar_modal_tabtitle3'); ?></a></li>
									<li><a href="#pane4" data-toggle="tab"><i class="fa fa-location-arrow"></i> <?php echo lang('calendar_modal_tabtitle4'); ?></a></li>
								 ...
								 <div class="tab-content">
									<div id="pane1" class="tab-pane active">								 
											...
											<div class="form-group"> 
												...
												<div class="col-md-7 col-xs-7">
													<input class="form-control" type="text" name="ic_event_title" id="c_event_title" placeholder="<?php echo lang('calendar_modal_eventname'); ?>" required/>
												</div>
											</div>										
											...
											<div class="form-group">		 
												...
												<div class="col-md-7 col-xs-7">
													<textarea class="form-control" name="ic_event_desc" id="c_event_desc" placeholder="<?php echo lang('calendar_modal_description'); ?>" ></textarea>
												</div>
											</div>
											...
											<div class="form-group">	
												...
												<div class="col-md-7 col-xs-7">
												    <div class="input-group date" id="createdtp1"> 
														<input class="form-control" type="text" name="ic_event_starttime" id="c_event_starttime" placeholder="<?php echo lang('calendar_modal_eventbegin'); ?>" required/>
											...
											<div class="form-group">
												...
												<div class="col-md-7 col-xs-7">
													<div class="input-group date" id="createdtp2"> 
														<input class="form-control" type="text" name="ic_event_endtime" id="c_event_endtime" placeholder="<?php echo lang('calendar_modal_eventend'); ?>" required/>
														<span class="input-group-addon">
															<span class="glyphicon glyphicon-calendar"></span>
														</span>
													</div> 	
											...
											<div class="form-group">
												...
												<div class="col-md-7 col-xs-7"> 
													 ...
													 <input class="col-md-1 col-xs-1" type="radio" name="ic_event_allday" id="c_event_alldayT" value="true" >
													 <span class="col-md-1 col-xs-1" for="inputNO"><?php echo lang('no'); ?></span>
													 <input class="col-md-1 col-xs-1" type="radio" name="ic_event_allday" id="c_event_alldayF" value="false" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7 col-xs-7">
													<input class="form-control" type="text" name="ic_event_urllink" id="c_event_urllink" value="" placeholder="http://" />
												</div>												
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7 col-xs-7">	
													<select class="form-control" name="ic_event_shareit" id="c_event_shareit" >  
									...
									<div id="pane2" class="tab-pane">
										...
										<div class="form-group">	
											...
											<div class='col-xs-7 col-md-7'> 
												 <input type="text" name="ic_event_bgcolor" id="c_event_bgcolor" class="form-control color_picker" data-position="bottom right" value="">
											</div>
										</div>
										<!-- Color select-->
										<div class="form-group">	
											...
											<div class='col-xs-7 col-md-7'>
												<input type="text" name="ic_event_textcolor" id="c_event_textcolor" class="form-control color_picker" data-position="bottom right" value=""> 
											</div>
										</div> 													
										<!-- Color select-->
										<div class="form-group">	
											...
											<div class='col-xs-7 col-md-7'>
												<input type="text" name="ic_event_bordercolor" id="c_event_bordercolor" class="form-control color_picker" data-position="bottom right" value="">
											</div>
										</div> 										
										<!-- Option select-->
										<div class="form-group">
											...
											<div class="col-md-7 col-xs-7">	
												<select class="form-control" name="ic_event_rendering" id="c_event_rendering" >
												  <option id="c_event_renderingF" value="" selected><?php echo lang('calendar_modal_eventfgrender'); ?></option>
												  <option id="c_event_renderingB" value="background" ><?php echo lang('calendar_modal_eventbgrender'); ?></option> 
												</select>
											</div>											
										</div> 
										<!-- Option select-->
										<div class="form-group">
											...
											<div class="col-md-7 col-xs-7">	
												<select class="form-control" name="ic_event_eventoverlap" id="ic_event_eventoverlap" >
												  <option id="c_event_eventoverlapT" value="true" ><?php echo lang('yes'); ?></option>
												  <option id="c_event_eventoverlapF" value="false" selected><?php echo lang('no'); ?></option> 
												</select>
											</div>											
										</div>		 
									...
									<div id="pane3" class="tab-pane"> 
										<div class="form-group">
											...
											<div class="col-md-7 col-xs-7 ">	 
												<select class="form-control" name="ic_event_recurring" id="c_event_recurring" size="7">
												  <option id="c_event_recurringnone" value="0" selected><?php echo lang('calendar_modal_eventnonerecurring'); ?></option>
												  <option id="c_event_recurringdaily" value="1" ><?php echo lang('calendar_modal_eventdaily'); ?></option>
												  <option id="c_event_recurringweekly" value="7" ><?php echo lang('calendar_modal_eventweekly'); ?></option>				
												  <option id="c_event_recurring2weeks" value="14" ><?php echo lang('calendar_modal_event2weeks'); ?></option>				
												  <option id="c_event_recurringmonthly" value="30" ><?php echo lang('calendar_modal_eventmonthly'); ?></option>			
												  <option id="c_event_recurringyearly" value="365" ><?php echo lang('calendar_modal_eventyearly'); ?></option>					
												</select>
											</div>
										</div> 
										<div class="form-group"> 
											...
											<div class="col-md-7 col-xs-7 ">	
												<div class="input-group date4" id="createdtp3"> 
													<input class="form-control" type="text" name="ic_event_endrecurring" id="c_event_endrecurring" value="" placeholder="<?php echo lang('calendar_modal_eventend'); ?>" />  
													<span class="input-group-addon">
														<span class="glyphicon glyphicon-calendar"></span>
													</span>
												</div>  
						...
						<div class="modal-body">	 
								 ...
								 <div class="tab-content">
									...
									<fieldset> 
										...
										<input type="hidden" name="apptID" id="apptID" > 
											...
											<div class="form-group">
												<label class="control-label col-md-4 col-xs-4" for="inputEvent"><?php echo lang('calendar_modal_eventname'); ?></label>
												<div class="col-md-7 col-xs-7">	
													<input class="form-control" type="text" name="ic_event_title" id="u_event_title" placeholder="<?php echo lang('calendar_modal_eventname'); ?>" />
												</div>
											</div>
											...
											<div class="form-group">
												<label class="control-label col-md-4 col-xs-4" for="inputDescr"><?php echo lang('calendar_modal_description'); ?></label>
												<div class="col-md-7 col-xs-7">	
													<textarea class="form-control" name="ic_event_desc" id="u_event_desc" placeholder="<?php echo lang('calendar_modal_description'); ?>" > </textarea>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-7 col-xs-7">	 
													<div class="input-group date3" id="updatedtp1"> 
														<input class="form-control" type="text" name="ic_event_starttime" id="u_event_starttime" placeholder="<?php echo lang('calendar_modal_eventbegin'); ?>" />
														<span class="input-group-addon">
															<span class="glyphicon glyphicon-calendar"></span>
														</span>
													</div> 													
											...
											<div class="form-group">
												...
												<div class="col-md-7 col-xs-7">	 
													<div class="input-group date4" id="updatedtp2"> 
														<input class="form-control" type="text" name="ic_event_endtime" id="u_event_endtime" placeholder="<?php echo lang('calendar_modal_eventend'); ?>" />
														<span class="input-group-addon">
															<span class="glyphicon glyphicon-calendar"></span>
														</span>
													</div> 		 
											...
											<div class="form-group">
												...
												<div class="col-md-7 col-xs-7"> 
													 <span class="pull-left" for="inputYES"><?php echo lang('yes'); ?></span>
													 <input class="col-md-1 col-xs-1" type="radio" name="ic_event_allday" id="u_event_alldayT" value="true">
													 <span class="col-md-1 col-xs-1" for="inputNO"><?php echo lang('no'); ?></span>
													 <input class="col-md-1 col-xs-1" type="radio" name="ic_event_allday" id="u_event_alldayF" value="false">
												</div>												
											</div>	
											...
											<div class="form-group">
												<label class="control-label col-md-4 col-xs-4" for="inputURL"><?php echo lang('calendar_modal_eventurl'); ?></label>
												<div class="col-md-7 col-xs-7">	
													<input class="form-control" type="text" name="ic_event_urllink" id="u_event_urllink" placeholder="http://" />
												</div>
											</div>
											...
											<div class="form-group" >	
												...
												<div class="col-md-7 col-xs-7">		 
												  <select class="form-control selectpicker" name="ic_event_shareit2" id="u_event_shareit2" data-live-search="false" data-actions-box="true" title=" ">   
													...
													<input type="hidden" name="ic_event_shareitg2" id="u_event_shareitg2" >
												</div>					
											</div>	
										...
										<div id="content_wrapper">
											<div id="event_generation_wrapper">	
												...
												<div class="form-group">	
													<label class="control-label col-md-4 col-xs-4" for="inputBgColor"><?php echo lang('calendar_modal_colorbackground'); ?></label>	
													<div class='col-xs-7 col-md-7'> 
														<input type="text" name="ic_event_bgcolor" id="u_event_bgcolor" class="form-control color_picker" data-position="bottom right" value="">
													</div>
												</div>
												<!-- Color select-->
												<div class="form-group">	
													<label class="control-label col-md-4 col-xs-4" for="inputTxtColor"><?php echo lang('calendar_modal_colortext'); ?></label>	
													<div class='col-xs-7 col-md-7'>							
														<input type="text" name="ic_event_textcolor" id="u_event_textcolor" class="form-control color_picker" data-position="bottom right" value="">	
													</div>
												</div> 													
												<!-- Color select-->
												<div class="form-group">	
													<label class="control-label col-md-4 col-xs-4" for="inputBrdColor"><?php echo lang('calendar_modal_colorborder'); ?></label>	
													<div class='col-xs-7 col-md-7'> 
														<input type="text" name="ic_event_bordercolor" id="u_event_bordercolor" class="form-control color_picker" data-position="bottom right" value=""> 
													</div>
												</div> 	 
												<!-- Rendering select-->
												<div class="form-group">
													<label class="control-label col-md-4 col-xs-4" for="inputRendering"><?php echo lang('calendar_modal_eventrendering'); ?></label>
													<div class="col-md-7 col-xs-7">	
														<select class="form-control" name="ic_event_rendering" id="u_event_rendering" >
														  <option id="u_event_renderingF" value="" ><?php echo lang('calendar_modal_eventfgrender'); ?></option>
														  <option id="u_event_renderingB" value="background" ><?php echo lang('calendar_modal_eventbgrender'); ?></option>													
														</select>
													</div>											
												</div>	 
												<!-- Overlap select-->
												<div class="form-group">
													<label class="control-label col-md-4 col-xs-4" for="inputOverlap"><?php echo lang('calendar_modal_eventoverlap'); ?></label>
													<div class="col-md-7 col-xs-7">	
														<select class="form-control" name="ic_event_eventoverlap" id="u_event_eventoverlap" >
														  <option id="u_event_eventoverlapT" value="true" ><?php echo lang('yes'); ?></option>
														  <option id="u_event_eventoverlapF" value="false" ><?php echo lang('no'); ?></option> 
														</select>
													</div>											
												</div>														
									...
									<div id="panel3" class="tab-pane">  
										<div class="form-group">
											<label class="control-label col-md-4 col-xs-4" for="inputRecurring"><?php echo lang('calendar_modal_eventrecurring'); ?></label>
											<div class='col-xs-7 col-md-7'> 	 
												<select class="form-control" name="ic_event_recurring" id="u_event_recurring" size="7">
												  <option id="u_event_recurringnone" value="0" ><?php echo lang('calendar_modal_eventnonerecurring'); ?></option>
												  <option id="u_event_recurringdaily" value="1" ><?php echo lang('calendar_modal_eventdaily'); ?></option>
												  <option id="u_event_recurringweekly" value="7" ><?php echo lang('calendar_modal_eventweekly'); ?></option>	
												  <option id="u_event_recurring2weeks" value="14" ><?php echo lang('calendar_modal_event2weeks'); ?></option>															  
												  <option id="u_event_recurringmonthly" value="30" ><?php echo lang('calendar_modal_eventmonthly'); ?></option>													
												  <option id="u_event_recurringyearly" value="365" ><?php echo lang('calendar_modal_eventyearly'); ?></option>													
												</select>
											</div>	 										 											
										</div> 	
										<div class="form-group"> 
							...
							<div class="modal-footer">	
								<div class="btn-group dropup pull-left">
									<button class="btn btn-danger " type="submit" name="delButton" id="delButton" ><i class="fa fa-trash"></i> <?php echo lang('delete'); ?></button>	 
								</div> 	
								<div class="btn-group dropup ">
