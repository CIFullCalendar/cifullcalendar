                            ...
                            <div class="pages"> 
                                ...
                                <div class="panel-body">
									<div class="row">
										...
										<?php echo form_open('admin/categories/edit/'.$editcategory->category_id, array('id' => 'form_edit', 'name' => 'form_edit', 'role' => 'form' )); ?>  
											<div class="modal-body">   
												
												<div class="form-group">
													<label class="control-label" for="inputName"><?php echo lang('username'); ?></label>
													<b class="form-control" ><?php echo $editcategory->username  ?></b> 
												</div> 												
												<div class="form-group">
												...
												<!-- groups select-->
												<div class="form-group">	
													<label for="inputShareit"><?php echo lang('categories_input_group'); ?></label> 
													<select class="form-control" name="category_group" id="category_group">	 
														<option id="private" value="0" <?php echo ($editcategory->gid == 0) ? 'selected' : '';?>><?php echo lang('categories_input_group_private'); ?></option>  	
														<option id="public" value="-1" <?php echo ($editcategory->gid == -1) ? 'selected' : '';?>><?php echo lang('categories_input_group_public'); ?></option>   
														<?php foreach ($groups as $group):?> 
														<?php $selected3 = null; if ($group['id'] == $editcategory->gid) {$selected3 = 'selected';} ?>
