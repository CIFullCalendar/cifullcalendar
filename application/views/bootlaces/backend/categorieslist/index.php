												...
												<table id="categories_dataTable" class="table" data-toolbar="#toolbar" data-locale="<?php echo $lang ?>" >
													<thead>
														<tr> 
															...
															<th data-field="username" data-align="center" data-sortable="true" data-width="15%"><?php echo lang('username'); ?></th>
															...
															<th data-field="groups" data-align="left" data-sortable="true" data-width="10%" ><?php echo lang('groups'); ?></th> 
	...
	<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="add" aria-hidden="true">
		  <div class="modal-dialog">
			<div class="modal-content">
				...
				<?php echo form_open('admin/categories/add', array('id' => 'form_add', 'name' => 'form_add', 'role' => 'form' )); ?>  
				<div class="modal-body">  				 
					...
					<!-- groups select-->
					<div class="form-group">	
						<label for="inputGroups"><?php echo lang('categories_input_group'); ?></label> 
						<select class="form-control" name="category_group" id="category_group">	  
							<option id="private" value="0" ><?php echo lang('categories_input_group_private'); ?></option>  	
							<option id="public" value="-1" ><?php echo lang('categories_input_group_public'); ?></option> 
						...
						<p class="help-block"><?php echo form_error('category_group'); ?></p> 
					</div>					
				</div>
