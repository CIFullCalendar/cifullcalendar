                                ...
                                <div class="col-sm-5 col-md-12 col-lg-5">
                                    ...
                                    <div class="product-description">  
										...
										<div class="col-md-12 col-lg-12"> 
											<p>&nbsp;</p>
											<p>Check it out! There are a lot of new features to play with.</p>
											<p>I appreciate your continued support and suggestions.</p> 
											<p>Thank you and enjoy.</p>
											<p>Regards</p>
											<p>Sir.Dre</p>
											<p><b>Default logins:</b>
												<ul>
													<li><a href="<?php echo site_url('user');?>" >u: user p: password</a></li> 
													<li><a href="<?php echo base_url();?>admin" >u: admin p: password1</a></li>
												</ul>
											</p>
										</div>

										<div class="col-md-4 col-sm-12">
											<a class="btn btn-success btn-lg" href="http://codecanyon.net/item/cifullcalendar-v3/8949440" style="width:100%;"><i class="fa fa-download"></i> Get</a>	 		
										</div>
            ...
            <div class="row">
                <div class="col-md-6">
					...
					<div class="about-us"> 
						...
						<h3>About</h3> 
						<p>CIFullCalendar+ is a server-side dynamic web application that is responsive to any layout of a viewing screen. The &ldquo;Super Saiyan Fusion&rdquo; power of CIFullCalendar allows users to organize, plan and share events to everyone. Simply, install it to your server and become a member then use the wonderful features by easily manipulating your events by dragging, dropping, resizing, clicking, touching, categorizing, linking and importing/exporting. </p> 
							...
							<div id="gallery-images" class="carousel slide " data-ride="carousel">
							  ...
							  <div class="carousel-inner" role="listbox">
								<div class="item active">
								 <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot1.png" />
								</div>
								<div class="item">
								 <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot2.png" />
								</div>
								<div class="item">
								  <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot3.png" />
								</div>								
								<div class="item">
								  <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot4.png" />
								</div>								
								<div class="item">
								  <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot5.png" />
								</div>								
								<div class="item">
								  <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot6.png" />
								</div>								
								<div class="item">
								  <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot7.png" />
								</div>								
								<div class="item">
								  <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot8.png" />
								</div>							
								<div class="item">
								  <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot9.png" />
								</div>								
								<div class="item">
								  <img class="img-responsive" alt="" src="http://www.sirdre.com/apps/cifullcalendar/assets/img/gallery/screen_shot10.png" />
								</div>
							  </div>
                    ...
                    <div class="features">
                        ...
                        <div class="row single-feature">
                            ...
                            <div class="col-md-10 feature-text">
								...
								<p>Export – Members are able to export a single event to their Google, Yahoo and live calendars or to a ICAL Format (ics/ical).</p>
                            </div>
                        </div>     
                        <div class="row single-feature">
                            <div class="col-md-2 feature-icon">
                            ...
                            <div class="col-md-10 feature-text">
								...
								<p>Google Maps – Members are able to use the google maps to view all their events location instantly.</p>
                        ...
                        <div class="row single-feature">
                            ...
                            <div class="col-md-10 feature-text">
								...
								<p>Template – Easily customize your own themes. (Currently using bootstrap v3.3.6).</p>
								<p>Icons – Easily add icons within your own themes. (Currently using font-awesome v4.5.0).</p>
