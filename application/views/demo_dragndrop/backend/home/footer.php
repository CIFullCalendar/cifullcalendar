	...
	<script src="<?php echo base_url();?>assets/plugins/fullcalendar-2.6.0/calendar.custom.min.js" ></script>   
	<script src="<?php echo base_url();?>assets/plugins/fullcalendar-2.6.0/lang-all.js" ></script>  
	<script src="<?php echo base_url();?>assets/plugins/fullcalendar-2.6.0/gcal.js" ></script> 		
	<!-- bootstrap JS -->
