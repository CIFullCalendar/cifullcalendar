                        ...
                        <div class="col-md-12 product-background">
                            <div class="row">								
                                ...
                                <div class="col-sm-5 col-md-12 col-lg-5">
									...
									<strong><?php echo $site_name ?></strong> v<strong><?php echo $current_version ?></strong> with current <?php echo 'CodeIgniter v<strong>' . CI_VERSION . '</strong>' ?> FullCalendar v<strong><span id="fcv"></span></strong>* and Scheduler v<strong><span id="fcsv"></span></strong>* fused like a&ldquo;Super Saiyan Fusion&rdquo;.
									</div></h2> 
                                    ...
                                    <div class="product-description">  
										...
										<?php if ((!$this->ion_auth->is_admin()) && (!$this->ion_auth->is_member())): ?> 		
											...
											<div class="col-md-6 col-sm-12">
												<?php echo anchor('login', '<i class="fa fa-sign-in"></i> '. lang('profile_signin'), 'style="width:100%;" class="btn btn-success btn-lg"') ?>	 		
											</div>
										<?php endif ?>											
										</div>				
