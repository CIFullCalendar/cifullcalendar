										...
										<?php echo form_open('admin/settings/calendar_settings', array('class' => 'form-horizontal', 'id' => 'form_cal', 'name' => 'form_cal')); ?> 
												...
												<div class="form-group">
													...
													<select class="form-control" name="cal_defaultview" id="cal_defaultview">
														...
														<option value="timelineDay" <?php if($defaultview == 'timelineDay'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_timelineDay'); ?></option>
														<option value="timelineWeek" <?php if($defaultview == 'timelineWeek'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_timelineWeek'); ?></option>
														<option value="timelineMonth" <?php if($defaultview == 'timelineMonth'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_timelineMonth'); ?></option>
														<option value="timelineYear" <?php if($defaultview == 'timelineYear'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_timelineYear'); ?></option>														
													</select>
												...
												<div class="form-group">
													...
													<div class="form-group" style="margin:0px 20px">
														...
														<select class="form-control" name="cal_weeknumberswithindays" id="cal_weeknumberswithindays">
															<option value="true" <?php if($weeknumberswithindays =='true'){ echo "SELECTED";}?> ><?php echo lang('yes'); ?></option>
															<option value="false" <?php if($weeknumberswithindays =='false'){ echo "SELECTED";}?> ><?php echo lang('no'); ?></option>
														</select>
