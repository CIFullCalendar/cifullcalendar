									...
									<div class="row">
										<div class="col-md-12 col-lg-12"> 
											...
											<?php echo form_open('admin/settings', array('class' => 'form-hoziontal', 'id' => 'form_settings', 'name' => 'form_settings', 'role' => 'form' )); ?>   
												...
												<div class="form-group">   
													<label class="control-label" for="inputSCHEDULERKEY"><?php echo lang('api_schedulerkey'); ?> <a href="https://fullcalendar.io/scheduler/purchase/" target="_blank">Reference here</a></label> 
													<input class="form-control" type="password" name="cal_schedulerkey" id="cal_schedulerkey" value="<?php echo set_value('cal_schedulerkey', $cal_schedulerkey); ?>"/> 
													<p class="help-block"><?php echo form_error('cal_schedulerkey'); ?></p>
												</div>
