                                ...
                                <div class="panel-body">
                                    <div class="row"> 
                                        <div class="col-md-12 col-sm-12"> 
											...
											<div class="form-group">
												<label><?php echo lang('cal_slotlabel_settings') ?></label>
												<div class="form-group" style="margin:0px 20px">
											...
											<div class="form-group">
												<label><?php echo lang('cal_weeknumbers_settings') ?></label>
												<div class="form-group" style="margin:0px 20px">
													...
													<label><?php echo lang('cal_weeknumbers_withindays') ?></label>
													<select class="form-control" name="cal_weeknumberswithindays" id="cal_weeknumberswithindays">
														<option value="true" <?php if($userinfo->cal_weeknumberswithindays =='true'){ echo "SELECTED";}?> ><?php echo lang('yes'); ?></option>
														<option value="false" <?php if($userinfo->cal_weeknumberswithindays =='false'){ echo "SELECTED";}?> ><?php echo lang('no'); ?></option>
													</select>
													<p class="help-block"><?php echo form_error('cal_weeknumberswithindays') ?></p>
