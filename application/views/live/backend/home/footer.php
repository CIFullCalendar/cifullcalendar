	...
	<!-- CIFullcalendar JS -->			 	
	<script src="<?php echo base_url();?>assets/plugins/fullcalendar-2.4.0/lib/jquery-ui.custom.min.js"></script> 
	<script src="<?php echo base_url();?>assets/plugins/fullcalendar-2.4.0/fullcalendar.min.js" ></script>	
	<script src="<?php echo base_url();?>assets/plugins/fullcalendar-2.4.0/scheduler.min.js" ></script> 
	<script src="<?php echo base_url();?>assets/plugins/fullcalendar-2.4.0/calendar.custom.min.js" ></script>  
