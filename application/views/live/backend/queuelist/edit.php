											...
											<div class="col-md-7 col-xs-7">	
												<select class="form-control" name="ic_event_shareit" id="ic_event_shareit">													
													<?php if(($events->auth) == 1):  ?>
													  ...
													  <option id="ic_event_ahareit" value="3"><?php echo lang('calendar_modal_eventpublic'); ?></option>	
													<?php else: ?>
													  <option id="ic_event_ahareit" value="1" ><?php echo lang('calendar_modal_eventprivate'); ?></option>
													  <option id="ic_event_ahareit" value="3" selected><?php echo lang('calendar_modal_eventpublic'); ?></option>	
													<?php endif ?>	  
												</select> 	
											</div>					
										</div>
