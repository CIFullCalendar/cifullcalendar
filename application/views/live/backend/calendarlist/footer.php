	...
	<script src="<?php echo base_url();?>assets/plugins/bootstrap-table/bootstrap-table-custom.calendar.min.js"></script> 
	...
	<script src="<?php echo base_url();?>assets/demo_dragndrop/js/admin.js" type="text/javascript" ></script>   