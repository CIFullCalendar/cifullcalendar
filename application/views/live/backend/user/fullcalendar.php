	...
	<div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><?php echo lang('settings_cal_name') ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->			
	            ...
	            <div class="col-md-12 col-lg-12">
                    <div class="panel panel-default">					
                        ...
                        <div class="panel-heading">
                            <i class="fa fa-calendar fa-fw"></i> <?php echo lang('settings_cal_name') ?> 
                        </div>
						<!-- /.panel-heading -->                       
						<div class="panel-body">						
							<form id="form_cal" name="form" method="post" action="<?php echo site_url('profile/user/fullcalendar'); ?>">
								<div class="form-group">
									...
									<select class="form-control" name="cal_timezone" id="cal_timezone">											
										...
										<option value="America/Halif(ax" <?php if($userinfo->cal_timezone =='America/Halif(ax') { echo "SELECTED";}?>  >America/Halif(ax</option>
								...
								<div class="form-group">
									...
									<select class="form-control" name="cal_defaultview" id="cal_defaultview">
										...
										<option value="timelineDay" <?php if($userinfo->cal_defaultview =='timelineDay'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_timelineDay'); ?></option>
										<option value="timelineWeek" <?php if($userinfo->cal_defaultview =='timelineWeek'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_timelineWeek'); ?></option>
										<option value="timelineMonth" <?php if($userinfo->cal_defaultview =='timelineMonth'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_timelineMonth'); ?></option>
										<option value="timelineYear" <?php if($userinfo->cal_defaultview =='timelineYear'){ echo "SELECTED";}?> ><?php echo lang('cal_defaultview_timelineYear'); ?></option>
									</select>
								...
								<div class="form-group">
									...
									<select class="form-control" name="cal_businesshours" id="cal_businesshours">
										<option value="true" <?php if($userinfo->cal_businesshours =='true'){ echo "SELECTED";}?> ><?php echo lang('yes'); ?></option>
										<option value="false" <?php if($userinfo->cal_businesshours =='false'){ echo "SELECTED";}?> ><?php echo lang('no'); ?></option>
									</select>
