				...
				<div class="navbar-default sidebar" role="navigation"> 
                    <ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<h3 ><?php echo lang('submenu_dropdown_all_sources'); ?></h3>
                        </li>					
                        <li>
						...
						<li>
							<a class="active" href="<?php echo site_url('profile/sources');?>" id="side-menu"><i class="fa fa-link fa-fw"></i> <?php echo lang('submenu_dropdown_all_sources'); ?></a>
						</li> 							
