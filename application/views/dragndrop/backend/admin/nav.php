			...
			<div class="collapse navbar-collapse" id="navbar-collapse-1">
				...
				<div class="navbar-inverse sidebar" role="navigation">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							...
							<form class="custom-search-form" role="search" method="post" >
								<div class="input-group" style="width:100%;">
									...
									<button class="btn btn-primary" id="submitsearch" type="submit"><i class="fa fa-search"></i></button>
									</span>
								</div> 
							</form>
                        ...
                        <li>
                            <a class="active" href="<?php echo site_url('admin');?>"><i class="fa fa-dashboard fa-fw"></i> <?php echo lang('dashboard') ?></a>
                        </li>                        
                        <li>
                        ...
                        <li> 
                            ...
                            <ul class="nav nav-second-level">
								<li>
									<a href="<?php echo site_url('admin/settings');?>"><i class="fa fa-gear fa-fw"></i> <?php echo lang('settings_basic_name') ?></a> 
								</li>
								<li>
									<a href="<?php echo site_url('admin/settings/calendar_settings');?>"><i class="fa fa-calendar fa-fw"></i> <?php echo lang('settings_cal_name') ?></a> 
								</li>								
								<li>
									<a href="<?php echo site_url('admin/settings/attachments');?>"><i class="fa fa-file-archive-o fa-fw"></i> <?php echo lang('settings_attach_name') ?></a> 
								</li>                                 
								<li>
									<a href="<?php echo site_url('admin/settings/icsfile');?>"><i class="fa fa-file fa-fw"></i> <?php echo lang('settings_file_name') ?></a> 
								</li> 								
								<li>
