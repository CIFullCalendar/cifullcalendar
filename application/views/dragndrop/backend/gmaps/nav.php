				...
				<div class="navbar-default sidebar" role="navigation"> 
                    <ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<h3 ><?php echo lang('submenu_dropdown_all_locations'); ?></h3>
                        </li>					
                        <li>
							<a href="<?php echo site_url('profile');?>" id="side-menu" ><i class="fa fa-calendar fa-fw"></i> <?php echo lang('calendar') ?></a> 
                        </li>
						<li>
							<a class="active" href="<?php echo site_url('profile/gmaps');?>" id="side-menu"><i class="fa fa-location-arrow fa-fw"></i> <?php echo lang('submenu_dropdown_all_locations'); ?></a>
						</li> 
						<li>
