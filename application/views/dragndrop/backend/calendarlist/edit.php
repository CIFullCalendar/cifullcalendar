								...
								<div class="form-group">	
									...
									<div class="col-md-7 col-xs-7">	
										<select class="form-control" name="ic_event_shareit" id="ic_event_shareit">		 
										  <option id="ic_event_ahareit" value="0" <?php $selected = null; if ($events->gid == 0) {$selected = 'selected';} ?>><?php echo lang('calendar_modal_eventprivate'); ?></option>
										  <option id="ic_event_ahareit" value="-1" <?php $selected = null; if ($events->gid < 0) {$selected = 'selected';} ?>><?php echo lang('calendar_modal_eventpublic'); ?></option>	  
