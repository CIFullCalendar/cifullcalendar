...
<html class="no-js" lang="en">
  <head>
	...
	<meta property="og:image" content="./assets/img/icons/icon_192x192.png">
  ...
  <div class="page-container header-page-container">
    ...
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav"> 
		  ...
		  <li><a class="header-page-link" href="#">Welcome</a></li>
      ...
      <div class="doc-content" role="main"> 
		...
		<form class="form-horizontal" name="install_form" id="install_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-md-7">
		      <input type="password" class="form-control" id="encryption_key" name="encryption_key"  placeholder="X5CdVYkJI9kjMdI5LNEerjbmCUMkbiYW" >
		      <span class="help-block pull-right" for="encryption_key">Try: <a href="./includes/ciencryptkey.php" target="_blank"> Encryption key Generator</a></span>
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="" class="col-md-3 control-label">Session Cookie Name</label>
		    <div class="col-md-7">
		      <input type="text" class="form-control" id="sess_cookie_name" name="sess_cookie_name" value="ci_gingerbread">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-md-7">
		      <input type="text" class="form-control" id="sess_expiration" name="sess_expiration" placeholder="83000" >
