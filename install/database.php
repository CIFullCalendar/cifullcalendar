    ...
    <div class="col-md-9 doc-content-wrap">
      <div class="doc-content" role="main"> 
		...
		<?php } else { ?>
			...
			<p><strong>Example</strong>: <code>chmod 775 "application/config/database.php"</code></p>
			</blockquote>
		<?php } ?>
		...
		<form class="form-horizontal" name="install_form" id="install_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		  ...
		  <div class="form-group">
		    <label for="" class="col-md-2 control-label">Driver</label>
		    <div class="col-md-5">
		      <span class="help-block pull-right" for="dbdriver">mysqli</span>
		      <span class="help-block pull-right" for="dbdriver">Note: for sqlsrv dbdriver set to pconnect = TRUE</span>
		    </div>
		  </div>		  
		  <div class="form-group">
		    <label for="" class="col-md-2 control-label">Username</label>
		    <div class="col-md-5">
		      <input type="text" class="form-control" id="username" name="username" placeholder="pma">
		    ...
		    <div class="col-md-5">
		      <input type="text" class="form-control" id="database" name="database" placeholder="ci_fullcalendar">
