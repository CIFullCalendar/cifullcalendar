...
<html class="no-js" lang="en">
  <head>
	...
	<title>Verify Server Settings</title>
  ...
  <div class="row">
    ...
    <div class="col-md-9 doc-content-wrap">
      <div class="doc-content" role="main"> 
		...
		<figure class="highlight">	
			<p><span>PHP Version</span>
			<?php echo ((version_compare(PHP_VERSION, '5.6.0', '>=') && version_compare(PHP_VERSION, '7.1.0', '<'))) ? '<span class="cp"> ' . PHP_VERSION . ' <i class="fa fa-check"></i></span>' : '<span class="k">PHP between 5.6 and 7.0 is required <i class="fa fa-times"></i></span>';
			?></p>
		</figure>
	...
	<h2 id="test-mail-function">Test Mail Function</h2> 
		...
		if (mail('andre@sirdre.com', 'Installation for ID:23X48610HH1026511', 'CIFullCalendar Installation', $headers)) {
		?>
